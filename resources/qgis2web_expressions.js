...
function exp___3rule0_eval_expression(context) {
    // PLACE = 'city'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('PLACE')  == 'city');
    } else {
        return (feature.get('PLACE')  == 'city');
    }
}
...
function exp___3rule1_eval_expression(context) {
    // PLACE = 'town'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('PLACE')  == 'town');
    } else {
        return (feature.get('PLACE')  == 'town');
    }
}
...
function exp___3rule2_eval_expression(context) {
    // PLACE = 'village'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('PLACE')  == 'village');
    } else {
        return (feature.get('PLACE')  == 'village');
    }
}
...
function exp___3rule3_eval_expression(context) {
    // PLACE = 'hamlet'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('PLACE')  == 'hamlet');
    } else {
        return (feature.get('PLACE')  == 'hamlet');
    }
}
...
function exp___3rule4_eval_expression(context) {
    // PLACE = 'locality'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('PLACE')  == 'locality');
    } else {
        return (feature.get('PLACE')  == 'locality');
    }
}